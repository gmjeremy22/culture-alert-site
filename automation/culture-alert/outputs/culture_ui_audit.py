...
REQUIRED_IDS = {
    ...
    "homeSearchForm": "첫 화면 검색창",
    "homeSearchInput": "첫 화면 검색 입력",
    "globalSearchOverlay": "사이트 전체 통합 검색창",
    "globalSearchInput": "기관·전시·주제 검색 입력",
    "globalSearchTypeFilters": "검색 결과 유형 필터",
    "globalSearchRegionFilters": "검색 지역 필터",
    "globalInstitutionResults": "통합 검색 기관 결과",
    "globalEventResults": "통합 검색 전시·일정 결과",
...
SCRIPT_FLOW_MARKERS = {
    ...
    "휴대폰 뒤로가기로 상세창 닫기": 'window.addEventListener("popstate"',
    ...
    "검색 유사어 확장": "SEARCH_SYNONYM_GROUPS",
    "기관 별칭 검색": "INSTITUTION_ALIAS_RULES",
    "검색 최소 관련성 기준": "function eventSearchMatch",
    "사이트 전체 검색 렌더링": "function renderGlobalSearch",
    "첫 화면 검색 실행": 'homeSearchForm.addEventListener("submit"',
...
def manual_review_checklist():
    return [
        ...
        "검색 관련성: 국현/MMCA/리움 같은 별칭, 현대 사진/아이와 공예 같은 복합 검색은 연관 결과만 표시되고 무관한 검색어에는 억지 결과가 나타나지 않는지 확인",
        "검색 모바일: 390x844에서 검색창·유형/지역 필터·결과가 잘리지 않고, 결과 상세를 열었다가 휴대폰 뒤로가기로 검색 결과와 원래 화면에 차례로 돌아오는지 확인",
